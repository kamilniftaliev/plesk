...
//}
$where = "status='done' AND id ='$id' AND tgl >= '$now' AND serviceid='1' OR serviceid='6'";
$db = getDbInstance();
$db->where($where);
            ...
            <div class="panel panel-green">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge"> Paket FRP <?php if ($paketfrp==1) {echo 'YES';} else {echo 'NO';} ?></div>
            ...
            <div class="panel panel-green">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge"> Paket MTK 6 <?php if ($paketv6==1) {echo 'YES';} else {echo 'NO';} ?></div>
