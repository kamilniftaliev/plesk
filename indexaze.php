      ...
      <div class="container d-flex justify-content-center justify-content-md-between">
        <div class="contact-info d-flex align-items-center">
          <i class="bi bi-envelope d-flex align-items-center"><a
              href="mailto:hikadul@gmail.com">sample@gmail.com</a></i>
    ...
    <div class="branding d-flex align-items-center">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        <a href="" class="logo d-flex align-items-center me-auto">
          ...
          <h1 class="sitename">
            <img src="https://upload.wikimedia.org/wikipedia/commons/a/ae/Xiaomi_logo_%282021-%29.svg" alt="Logo"
              class="logo">AzeGsm
          </h1>
        </a>
              ...
              <div class="row gy-4">
                ...
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box" data-aos="zoom-out" data-aos-delay="300">
                    ...
                    <h4>
                      <p id="blink"> SERVER QCOM / MTK RODIN STATUS </p>
                    </h4>
                ...
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box" data-aos="zoom-out" data-aos-delay="300">
                    <i class="bi bi-clipboard-data"></i>
                    <h4>
                      <p id="blink"> SERVER MTK 6 OLD STATUS </p>
                    </h4>
                    <p><?php echo "OFF"; ?></p>
                  </div>
                </div><!-- End Icon Box -->
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item  position-relative">
              ...
              <a href="https://drive.google.com/file/d/1sTQ1Ydz2qNwnSTHjg-X_0vVXa4ixY4Co/view?usp=drive_link"
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <a href="https://drive.google.com/file/d/1R3FKsPGhuFcfN7Tvt_Tf4QP2OxEzRKMu/view?usp=drive_link"
                class="stretched-link">
                <h3>MTK 6 FLASH</h3>
              </a>
              <p>Zip Pass 1</p>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="service-item position-relative">
              ...
              <a href="https://drive.google.com/file/d/1cedLGoIGONNo-Tmx_Fm_smP_lGFWm1AZ/view?usp=drive_link"
                class="stretched-link">
                <h3>FRP RECOVERY</h3>
              </a>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="service-item position-relative">
              ...
              <a href="https://drive.google.com/file/d/1r92SpYH_8WSe79n9sRXDGiIGghjGXBab/view?usp=drive_link"
                class="stretched-link">
                <h3>ALL IN TOOL</h3>
              </a>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center">
            <i class="fa-solid fa-user-doctor"></i>
            <div class="stats-item">
              <span data-purecounter-start="0" data-purecounter-end='<?php echo $flash ?>' data-purecounter-duration="1"
          ...
          <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center">
            <i class="fa-regular fa-hospital"></i>
            <div class="stats-item">
              <span data-purecounter-start="0" data-purecounter-end="<?php echo $frp ?>" data-purecounter-duration="1"
                class="purecounter"></span>
          ...
          <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center">
            ...
            <div class="stats-item">
              <span data-purecounter-start="0" data-purecounter-end="<?php echo $fdl ?>" data-purecounter-duration="1"
                class="purecounter"></span>
          ...
          <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center">
            <i class="fa-solid fa-user-doctor"></i>
            <div class="stats-item">
              <span data-purecounter-start="0" data-purecounter-end='<?php echo $allflash ?>'
          ...
          <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center">
            <i class="fa-regular fa-hospital"></i>
            <div class="stats-item">
              <span data-purecounter-start="0" data-purecounter-end="<?php echo $allfrp ?>"
                data-purecounter-duration="1" class="purecounter"></span>
              <p>ALL Success FRP</p>
            </div>
          </div><!-- End Stats Item -->
          ...
          <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center">
            <i class="fas fa-flask"></i>
            <div class="stats-item">
              <span data-purecounter-start="0" data-purecounter-end="<?php echo $allfdl ?>"
                data-purecounter-duration="1" class="purecounter"></span>
              <p>ALL Success FDL</p>
            </div>
          </div><!-- End Stats Item -->
          ...
          <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center">
            <i class="fas fa-flask"></i>
            <div class="stats-item">
              <span data-purecounter-start="0" data-purecounter-end="<?php echo $failflash ?>"
                data-purecounter-duration="1" class="purecounter"></span>
          ...
          <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center">
            <i class="fas fa-flask"></i>
            <div class="stats-item">
              <span data-purecounter-start="0" data-purecounter-end="<?php echo $failfrp ?>"
                data-purecounter-duration="1" class="purecounter"></span>
              <p>Fail FRP Today</p>
            </div>
          </div><!-- End Stats Item -->
          ...
          <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center">
            <i class="fa-solid fa-user-doctor"></i>
            <div class="stats-item">
              <span data-purecounter-start="0" data-purecounter-end='<?php echo $failfdl ?>'
                data-purecounter-duration="1" class="purecounter"></span>
              <p>Fail FDL Today</p>
            </div>
          </div><!-- End Stats Item -->
          ...
          <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center">
            <i class="fas fa-flask"></i>
            <div class="stats-item">
              <span data-purecounter-start="0" data-purecounter-end="<?php echo $allfailflash ?>"
                data-purecounter-duration="1" class="purecounter"></span>
              <p>ALL Fail Flash</p>
            </div>
          </div><!-- End Stats Item -->
          ...
          <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center">
            <i class="fas fa-flask"></i>
            <div class="stats-item">
              <span data-purecounter-start="0" data-purecounter-end="<?php echo $allfailfrp ?>"
                data-purecounter-duration="1" class="purecounter"></span>
              <p>ALL Fail FRP</p>
            </div>
          </div><!-- End Stats Item -->
          ...
          <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center">
            <i class="fa-solid fa-user-doctor"></i>
            <div class="stats-item">
              <span data-purecounter-start="0" data-purecounter-end='<?php echo $allfailfdl ?>'
                data-purecounter-duration="1" class="purecounter"></span>
              <p> ALL Fail FDL</p>
            </div>
          </div><!-- End Stats Item -->
  ...
  <footer id="footer" class="footer light-background">
    ...
    <div class="container footer-top">
      ...
      <div class="container copyright text-center mt-4">
        <p>© <span>Copyright</span> <strong class="px-1 sitename">AzeGsm Auth</strong> <span>All Rights Reserved</span>
        </p>
        <div class="credits">
