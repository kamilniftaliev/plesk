...
<body>
	...
	<table id ="serverlimit" class="data-table">
		...
		while ($row = mysqli_fetch_array($query))
		{
		    ?>
			    <tr>
					<td>  <input type="text" maxlength="4" size="4" id="ids<?php echo $no; ?>" value="<?php echo $row['id']; ?>" name="fname" readonly ></td>
					<td>
			...
			<td>  <input type="text"  maxlength="4" size="4" id="limitflash<?php echo $no; ?>" value="<?php echo $row['limitsetflash'] ?>" name="fname"  ></td>
			<td>  <input type="text"  maxlength="4" size="4" id="limitfrp<?php echo $no; ?>" value="<?php echo $row['limitsetfrp'] ?>" name="fname"  ></td>
			<td>  <input type="text"  maxlength="4" size="4" id="limitfdl<?php echo $no; ?>" value="<?php echo $row['limitsetfdl'] ?>" name="fname"  ></td>
