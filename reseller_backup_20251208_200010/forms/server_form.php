 ...
 <!--  <input type="text" name="status" autocomplete="off" placeholder="Credit Amount " class="form-control" value=" autocomplete="off" -->
    ...
    <div class="form-group">
        ...
        <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                <input  type="text" name="passtoken" autocomplete="off" placeholder="passtoken" class="form-control" value="<?php echo ($edit) ? $admin_account['passtoken'] : ''; ?>" autocomplete="off" >
            </div>
        </div>
    </div>
        <div class="form-group">
        ...
        <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                <input  type="text" name="uid" autocomplete="off" placeholder="uid" class="form-control" value="<?php echo ($edit) ? $admin_account['uid'] : ''; ?>" autocomplete="off" >
            </div>
        </div>
    </div>
        ...
        <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                <input  type="text" name="deviceid" autocomplete="off" placeholder="devices id" class="form-control" value="<?php echo ($edit) ? $admin_account['deviceid'] : ''; ?>" autocomplete="off" >
            </div>
        </div>
    </div>
        <!-- Text input-->
    ...
    <div class="form-group">
        ...
        <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                <input  type="text" name="apiurl" autocomplete="off" placeholder="api mi" class="form-control" value="<?php echo ($edit) ? $admin_account['apiurl'] : ''; ?>" autocomplete="off" >
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                <input  type="text" name="limitflash" autocomplete="off" placeholder="user name" class="form-control" value="<?php echo ($edit) ? $admin_account['limitedl'] : ''; ?>" autocomplete="off" >
            </div>
        </div>
    </div>
        ...
        <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                 <input type="text" name="limitfrp" autocomplete="off" placeholder="Credit Amount " class="form-control" value="<?php echo ($edit) ? $admin_account['limitfrp'] : ''; ?>" autocomplete="off" >
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                  <input type="text" name="limitfdl" autocomplete="off" placeholder="Credit Amount " class="form-control" value="<?php echo ($edit) ? $admin_account['limitfdl'] : ''; ?>" autocomplete="off" >
            </div>
        </div>
    </div>
