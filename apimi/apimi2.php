...
$ssecurity = $_POST['ssecurity'];
	...
	$miconfig  = GetMiConfig($serviceId ,$configblob,$userId,$deviceId,$platformname,$projectname);
	if (!$miconfig) 
	{
...
function GetMiConfig($serviceid,$configblob,$userId,$deviceId,$platformname,$projectname){
	...
	if($serviceid == 8){
		...
		$datapoststring = '{"SEClevel" : "0","clientId" : "mtkFlash","clientVersion" : "5.3.1209.3","cmdtype" : "1","flashToken" : "'.$configblob.'","paddingtype" : "1","pattern" : "2","pcId" : "","platform" : "'.$platformname.'","project" : "'.$projectname.'"}';
	...
	if($serviceid == 11){
		// next will update depent project load from tool for device name
		$token = $configblob;	
		$datapoststring = '{"SEClevel" : "0","clientId" : "mtkFlash","clientVersion" : "5.3.1209.3","cmdtype" : "1","flashToken" : "'.$configblob.'","paddingtype" : "1","pattern" : "2","pcId" : "","platform" : "'.$platformname.'","project" : "'.$projectname.'"}';
		$url = "/api/v1/mtk/flash/ahaFlash";
		return [$token,$datapoststring,$url];
