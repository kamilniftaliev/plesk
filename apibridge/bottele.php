...
switch ($cmd) {
    ...
    case "/setfrp":
        ...
        if ($stat) {
            $reply = $actdeact . " FRP PACKET " . $username . " SUCCESS";
        } else {
            $reply = $actdeact . " FRP PACKET " . $username . " FAILED";
        }
    ...
    case "/setpaketmtk":
        ...
        if ($stat) {
            $reply = $actdeact . "MTK 6 PACKET " . $username . " " . $jumlahpaket . " Devices  SUCCESS";
        } else {
            $reply = $actdeact . " MTK PACKET " . $username . " FAILED";
        }
    ...
    case "/paketmtk":
        ...
        if ($stat) {
            $reply = $actdeact . "MTK 6 PACKET " . $status . " Manually SUCCESS";
        } else {
            $reply = $actdeact . " MTK PACKET " . $username . " FAILED";
        }
