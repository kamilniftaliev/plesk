        ...
        <div class="modern-sidebar">
            ...
            <div class="flex items-center justify-between px-6 py-5 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center gap-2">
                    <div class="w-8 h-8 bg-blue-600 dark:bg-white rounded-lg flex items-center justify-center">
                        <svg class="w-5 h-5 text-white dark:text-slate-800" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                    ...
                    <span class="text-gray-900 dark:text-white font-bold text-lg">Server Admin</span>
                </div>
            </div>
